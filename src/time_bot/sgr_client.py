...
- time_log — пользователь явно логирует, сколько минут потратил на активность (обычно упоминает длительность, например «30 минут чтения книги»). Если сообщение начинается с числа минут, часов или содержит шаблон «N минут», «час», «за 25 мин» и т.д., почти всегда это time_log.
